...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, determineSeparator('database/database/create_skeleton_table.php.stub')) => rename($file, determineSeparator('./database/database/create_'.title_snake($packageSlugWithoutPrefix).'_table.php.stub')),
